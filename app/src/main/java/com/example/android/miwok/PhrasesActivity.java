...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("What is your name?", "Onamaehanandesuka?",
        ...
        words.add(new Word("Yes, I’m coming.", "Hai, kimasu\n", R.raw.phrase_yes_im_coming));
        words.add(new Word("I’m coming.", "Ima okonatteru", R.raw.phrase_im_coming));
        words.add(new Word("Let’s go.", "Yukō", R.raw.phrase_lets_go));
